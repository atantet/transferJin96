...
/** \file POContJin86.cpp 
 *  \ingroup examples
 *  \brief Fixed point continuation in Jin 96 model.
 *
 *  Fixed point continuation in Jin 96 (Roberts et al. 2016) model.
 */
...
int main(int argc, char * argv[])
{
  ...
  vectorField *field = new Jin86Cont(sigma, beta);
  
  // Define linearized field
  std::cout << "Defining Jacobian, initialized at initCont..." << std::endl;
  linearField *Jacobian = new JacobianJin86Cont(sigma, beta, initCont);
